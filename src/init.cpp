    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Newcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  newcoind [options]                     " + "\n" +
                  "  newcoind [options] <command> [params]  " + _("Send command to -server or newcoind") + "\n" +
                  "  newcoind [options] help                " + _("List commands") + "\n" +
                  "  newcoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: newcoind.pid)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 3332 or testnet: 13332)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Newcoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Newcoin is probably already running."), strDataDir.c_str()));
